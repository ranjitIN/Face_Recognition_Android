...
import com.example.facerecognition.facefinder.FaceFindProcessor
...
class CameraManager(
    ...
    private lateinit var faceClassfier:TfliteFaceClassifier

    init {
        createNewExecutor()
        faceClassfier = TfliteFaceClassifier(context)
    }
    ...
    private fun selectAnalyzer(): ImageAnalysis.Analyzer {
        return FaceFindProcessor(resultTextView,faceClassfier)
    }
